...
def build_parameters(test_parameters = False, nuc_algo = []):
    if test_parameters:
        ...
        all_algo_parameters = {
        'SBNUCIRFPA':               {'eta' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'AdaSBNUCIRFPA':            {'K' : [10000, 1000, 100, 10, 1, 0.1, 0.01, 0.001, 0.0001]},
        'AdaSBNUCIRFPA_reg':        {'K' : [10000, 1000, 100, 10, 1, 0.1, 0.01, 0.001, 0.0001],
                                     'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'CstStatSBNUC':             {'threshold' : [0, 5, 10, 15, 20, 30], # px error threshold - 0 to 255
                                     'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'SBNUCLMS':                 {'K' : [10000, 1000, 100, 10, 1, 0.1, 0.01, 0.001, 0.0001],
                                     'M' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'threshold' : [0, 5, 10, 15, 20, 30]},  # px error threshold - 0 to 255
        'SBNUCif_reg':              {'lr' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'algo' : ['OptFlow', 'BlockMotion', 'FourierShift']}, # motion estimation
        'AdaSBNUCif_reg':           {'lr' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'algo' : ['OptFlow', 'BlockMotion', 'FourierShift']}, # motion estimation
        # 'CompTempNUC':            {},        
        'NUCnlFilter':              {'Ts' : [0, 5, 10, 15, 20, 30], # px error threshold - 0 to 255
                                     'Tg' : [0, 10, 20, 50, 100, 150, 200, 500, 1000, 15000, 2000]}, # number of px error to estimate motion (TODO - change it to frame motion rate ?)
        'RobustNUCIRFPA':           {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'ada' : [True, False],
                                     'algo' : ['OptFlow', 'BlockMotion', 'FourierShift']}, # motion estimation
        'AdaRobustNUCIRFPA':        {'alpha_m' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'ada' : [True, False],
                                     'algo' : ['OptFlow', 'BlockMotion', 'FourierShift']}, # motion estimation
        'SBNUC_smartCam_pipeA':     {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'exp_window' : [True, False]},
        'SBNUC_smartCam_pipeB':     {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'alpha_p' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'exp_window' : [True, False]},
        'SBNUC_smartCam_pipeC':     {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'alpha_p' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'alpha_avg' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'SBNUC_smartCam_own_pipe':  {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'alpha_p' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'exp_window' : [True, False]},
        'SBNUCcomplement':          {}, # no more parameter
        'morgan':                   {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'morgan_moving':            {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'moving_rate' : [0, 0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5]}, # threshold based on frame motion rate
        'morgan_filt' :             {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        ...
        'zac_AdaSBNUCIRFPA_window' :{'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'K' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'zac_AdaSBNUCIRFPA_mean' :  {'eta' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'zac_AdaSBNUCIRFPA_reg' :   {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'K' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'zac_RobustNUCIRFPA' :      {'alpha_m' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'zac_SBNUCcomplement' :     {}, # no more parameter
        'zac_CstStatSBNUC' :        {'threshold' : [0, 5, 10, 15, 20, 30], # px error threshold - 0 to 255
                                     'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        'zac_SBNUCLMS' :            {'K' : [10000, 1000, 100, 10, 1, 0.1, 0.01, 0.001, 0.0001],
                                     'M' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'threshold' : [0, 5, 10, 15, 20, 30]},  # px error threshold - 0 to 255
        'zac_AdaSBNUCif_reg' :      {'lr' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'algo' : ['OptFlow', 'BlockMotion', 'FourierShift']}, # motion estimation
        'zac_morgan' :              {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'alpha_k' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'moving_rate' : [0, 0.01, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5]}, # threshold based on frame motion rate
        'zac_Adamorgan' :           {'alpha' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001], 
                                     'K' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001],
                                     'A' : [0.1, 0.01,  0.001, 0.0001, 0.00001, 0.000001, 0.0000001]},
        }
